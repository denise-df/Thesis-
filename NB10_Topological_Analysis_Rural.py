...
# =====================================================================
# 7. MAP GENERATION (FOLIUM) - ENRICHED RURAL TOPOLOGY
# =====================================================================
colors_express = ['#e6194b', '#3cb44b', '#ffe119', '#4363d8', '#f58231']
m_rural = folium.Map(location=hub_coords, tiles='cartodbpositron') 
...
m_rural.fit_bounds([[min(all_lats), min(all_lons)], [max(all_lats), max(all_lons)]])

# Dashboard HTML Overlay (Specifica per il contesto rurale)
title_html_pro = f'''
