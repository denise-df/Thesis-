...
# ========================================================================
# LOGICA IMMAGINE DI SFONDO (AGGIUNTA)
# ========================================================================
...
# Percorso relativo: assicurati di caricare 'background_van.jpg' nella cartella 'website' su GitHub
...
try:
    ...
    # Se non trova l'immagine, usa il colore originale per non rompere il sito
    bg_img_style = "none"
    # st.sidebar.error(f"Immagine non trovata: {e}") # Decommenta per debug
# ========================================================================
# NAVIGATION
# ========================================================================
