...
def get_physics(traffic, sla, dist_km):
    ...
    s_map = {"Standard": 1.00, "Next-Day": 1.05, "Express": 1.28, "Same-Day": 1.55}
    ...
    <div class='justification-box'>
        ...
        <div class='just-text'>
            ...
            <ul>
                ...
                <li style='margin-bottom: 0.8rem;'><b>Machine Learning Core:</b> The baseline prediction is validated against a <b>Gradient Boosting</b> regressor (scikit-learn). This algorithm was trained and cross-validated on over 150,000 high-frequency (1 Hz) OBD-II telemetry records, achieving an out-of-sample R&sup2; of 0.74. Electric vehicle baselines utilise Ridge Regression with degree-2 polynomial features, trained on the <b>CN/CLTC sub-sample (n=160) of Mai et al. (2025)</b> and rescaled by a <b>+12.04% CLTC→WLTP correction factor</b> (Cheng et al. 2025) to align predictions with the European homologation standard.</li>
...
with tab_cost:
    ...
    sla_mult_map = {"Standard": 1.00, "Next-Day": 1.05, "Express": 1.28, "Same-Day": 1.55}
