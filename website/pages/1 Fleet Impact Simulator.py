...
FLEET = {
    "Thermal Van": {
        ...
        "source":"OBD-II telemetry (150,000 records, 1 Hz)","trips":4187,
        "co2":185,"eff":"20–30%","cap":1200,"range":600,"cost":0.45,
        "traffic":"×2.5 in gridlock","use":"Standard last-mile, inter-city",
    },
    "Electric Van": {
        "icon":"🚐","type":"EV","badge":"electric",
        "model":"BEV LCV archetype (75 kWh LFP, 2,200 kg)",
        "source":"Mai et al. (2025) CN BEV dataset + WLTP correction","trips":160,
        "co2":40,"eff":"85–90%","cap":900,"range":250,"cost":0.12,
        "traffic":"×1.1 (regen braking)","use":"Urban last-mile, ZEZ zones",
    },
    "Thermal Truck": {
        "icon":"🚛","type":"ICE","badge":"thermal",
        "model":"7.5 t Diesel Rigid (Euro 6)",
        "source":"Market archetype (scaled from Van ICE)†","trips":4145,
    ...
    "Thermal Scooter": {
        ...
        "source":"Market archetype (last-mile reference)","trips":2080,
        "co2":65,"eff":"15–22%","cap":25,"range":150,"cost":0.08,
        "traffic":"×1.8 in gridlock","use":"Urban express, food delivery",
    },
    "Electric Bike": {
        "icon":"🚴","type":"EV","badge":"electric",
        "model":"E-Cargo Bike (250 W, ~25 km/h cap)",
        "source":"Market archetype (urban micro-mobility)†","trips":651,
    ...
    "Pedal Bike": {
        ...
        "model":"Cargo Bike (Babboe / Urban Arrow type)",
...
<div class='fleet-hero'>
    ...
    <p class='fleet-sub'>
        ...
        traffic resilience — combining real OBD-II telemetry for the Thermal Van archetype
        with certified BEV specifications (Mai et al. 2025) and market reference parameters
...
† Electric Bike: market-archetype parameters scaled to a 250 W e-cargo class (−40% mass, capped at 25 km/h).<br>
Sources: ICCT 2023 · UK Gov GHG Conversion Factors 2024 · Mai et al. (2025) <em>Scientific Data</em> 12, 1449 · Cheng et al. (2025) <em>WEVJ</em> 16, 124 · Chester &amp; Horvath (2010).
</div>
""", unsafe_allow_html=True)
